        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(cd.isConnectingToInternet()){
                    new www.tecjaunt.com.masterfit.actions.AsyncTask.Signup(SubCategories.this,"Link").execute("http://app.masterfitlife.com/index.php/api/Data_Storage/links/?sid="+list.get(position).getUid());
                }else{
                    Toast.makeText(SubCategories.this, "No Internet Connection Available", Toast.LENGTH_SHORT).show();
                }
            }
        });
